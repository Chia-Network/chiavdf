...
public:
  ...
  mpz_t negative_a, r, denom, old_b, ra, s, x, old_a, g, d, e, q, w, u, a, b, m,
      k, mu, v, sigma, lambda, h, t, l, j;
  form f3;
  ...
  // such that x = u + vn (n are all integers). Assumes that mu and v are
  // initialized. Returns 0 on success, -1 on failure
  int solve_linear_congruence(mpz_t &mu, mpz_t &v, mpz_t &a, mpz_t &b,
                              mpz_t &m) {
  ...
  vdf_original() {
    mpz_inits(negative_a, r, denom, old_a, old_b, ra, s, x, g, d, e, q, w, m, u,
              a, b, k, mu, v, sigma, lambda, f3.a, f3.b, f3.c, // f3.d,
              NULL);
  }
