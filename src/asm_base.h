...
#endif
  APPEND_M(
      str("MOV [asm_tracking_data_comments+#], RAX", to_hex(8 * (id - 1))));
...
string constant_address_uint64(uint64 value_bits_0, uint64 value_bits_1,
...
string constant_address_double(double value_0, double value_1,
                               bool use_brackets = true) {
...
string constant_address_avx512_uint64(array<uint64, 8> value,
                                      bool use_brackets = true) {
