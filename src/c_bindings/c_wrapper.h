...
bool verify_n_wesolowski_wrapper(const uint8_t* discriminant_size_bits, size_t discriminant_size, const uint8_t* x_s, size_t x_s_size, const uint8_t* proof_blob, size_t proof_blob_size, uint64_t num_iterations, uint64_t recursion);
